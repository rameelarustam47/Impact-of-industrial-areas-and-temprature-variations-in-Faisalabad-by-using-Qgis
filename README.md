...
This repository contains geospatial data, analysis scripts, and visualizations for assessing the impact of industrial areas on land surface temperature (LST) in Faisalabad, Pakistan. The project uses Google Earth Engine (GEE) to generate yearly LST rasters and QGIS for mapping and spatial analysis of major industrial clusters, including Nishat Mills, Interloop, Kamal Limited, and others.

**The repository includes:**

CSV files of major industries with coordinates 
